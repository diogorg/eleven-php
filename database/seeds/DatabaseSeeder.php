...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('booglans')->insert([
            'id' => 1,
            'text' => 'hnh fcxm jkd bxwkd gzq wmhxmmjg lvnfj sbbszwrh jvvzgr wjjkbjn bhhfwgn mxdwmx pbfwwvph mfh ncnw zkbx xkwdbdt fngmrcts 
...
bnpbjz spmcmpls bdlr fwscncn wksx tnxn hpmwbs ftcxbv whqn',
        ...
        DB::table('booglans')->insert([
            'id' => 2,
            'text' => 'pxxph zxsndg zbgpm ncgsq dmrk ttcv trrzq qdkxddbk jxw bmp gqjcl fnk tlfcmw klfqccx jptn gmt cgksrct dxrlfcc xdkkg vqxtz 
